...
namespace Google.Protobuf
{
    public class CodedInputStreamTest
    {
        ...
        /// <summary>
        /// Tests that if we read an string that contains invalid UTF-8, an exception
        /// is thrown.
        /// </summary>
        [Test]
        public void ReadInvalidUtf8ThrowsDecoderFallbackException()
        {
            MemoryStream ms = new MemoryStream();
            CodedOutputStream output = new CodedOutputStream(ms);
            ...
            Assert.AreEqual(tag, input.ReadTag());
            Assert.Throws<DecoderFallbackException>(() => input.ReadString());
        }
